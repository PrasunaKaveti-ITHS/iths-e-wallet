    ...
    <main>
        ...
        <section class="add-card-form">
            <form class="submit-card" @submit.prevent="send" ref="form">
                ...
                <the-mask mask="#### #### #### ####" type="text" name="cardNumber" class="card-number" placeholder="XXXX XXXX XXXX XXXX" v-model="DefaultCard.number" />
                <label for="cardholderName">cardholder name</label>
                <input type="text" name="cardholderName" class="cardholder-name" placeholder="Firstname Lastname" v-model="DefaultCard.holder" />
                <div class="valid-cvc">
